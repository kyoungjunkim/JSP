...
<main id="board">
    <section class="view">
        ...
        <div>
            ...
            <a href="/Farmstory3/board/modify.do?group=${group}&cate=${cate}" class="btn btnModify">수정</a>
            <a href="/Farmstory3/board/list.do?group=${group}&cate=${cate}" class="btn btnList">목록</a>
        </div>
